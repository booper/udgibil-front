        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          <form class="grid flex-1 grid-cols-1" action="#" method="GET">
            <input
              ...
              name="search"
              aria-label="Search"
              class="col-start-1 row-start-1 block size-full bg-transparent pl-8 text-base text-white outline-none placeholder:text-gray-500 sm:text-sm/6"
              placeholder="Search"
            />
            <MagnifyingGlassIcon
        ...
        <ul role="list" class="divide-y divide-white/5">
          ...
          >
            <div class="flex items-center gap-x-3">
              ...
              />
              <h3 class="flex-auto truncate text-sm/6 font-semibold text-white">
                {{ item.user.name }}
              </h3>
              <time
